...
!(function (t) {
  ...
  function x(t, n) {
    sn &&
      ...
      un.push(t),
      on.push(n && 'undefined' != typeof n.stack ? n.stack : '(no stack) ' + n))
  }
  function T(t) {
    if (sn) {
      var n = X(un, t)
      ;-1 !== n &&
        ('object' == typeof process &&
          ...
          p.nextTick.runAfter(function () {
            var e = X(cn, t)
            ;-1 !== e &&
              (process.emit('rejectionHandled', on[n], t), cn.splice(e, 1))
          }),
        un.splice(n, 1),
        on.splice(n, 1))
    }
  ...
  var H,
    ...
    J = (function () {
      ...
      if (
        ((J = function (t) {
          ;(r = r.next = { task: t, domain: u && process.domain, next: null }),
            o || ((o = !0), i())
        }),
        'object' == typeof process &&
  ...
  ;(p.resetUnhandledRejections = b),
    ...
    (h.prototype.nfapply = function (t) {
      var n = a(),
        e = L(t)
      return (
        e.push(n.makeNodeResolver()), this.fapply(e).fail(n.reject), n.promise
      )
    }),
    (p.nfcall = function (t) {
      var n = L(arguments, 1)
    ...
    (h.prototype.nfcall = function () {
      var t = L(arguments),
        n = a()
      return (
        t.push(n.makeNodeResolver()), this.fapply(t).fail(n.reject), n.promise
      )
    }),
    ...
    (p.nbind = function (t, n) {
      ...
      return function () {
        ...
        var o = e.concat(L(arguments)),
          i = a()
        return (
          o.push(i.makeNodeResolver()), p(r).fapply(o).fail(i.reject), i.promise
        )
      }
    }),
